...
class FindPasswordController: UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        let attributeString = NSMutableAttributedString(string: "Forgot ID",
    ...
    @IBAction func goFindID(_ sender: UIButton) {
    ...
    func parseNumber(_ data: Data){
        do {
            ...
            if readableJSON["return"] as? NSNumber == 1 {
                ...
                UserDefaults.standard.set("password", forKey: "findPW")

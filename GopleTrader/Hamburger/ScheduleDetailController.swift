...
class ScheduleDetailController: UIViewController, UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        if UserDefaults.standard.object(forKey: "scheduleDetailURL") != nil {
            url = UserDefaults.standard.object(forKey: "scheduleDetailURL") as! String
        }
        
        let request = URLRequest(url: URL(string : domain + url)!)
...
extension ScheduleDetailController {
...
extension ScheduleDetailController: WKScriptMessageHandler {
...
extension ScheduleDetailController: WKNavigationDelegate {
...
extension ScheduleDetailController: WKUIDelegate {
